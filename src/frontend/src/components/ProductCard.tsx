  ...
  return (
    ...
    >
      ...
      <Link to={`/productinfo?id=${product.id}`} className="block">
        <div className="aspect-square mb-6 rounded-2xl overflow-hidden bg-gray-800/50 flex items-center justify-center border border-gray-700/50 group-hover:border-blue-500/30 transition-colors">
          {product.image_url ? (
            <img 
