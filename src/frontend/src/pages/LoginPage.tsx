    ...
    <div className="min-h-screen flex items-center justify-center bg-black overflow-hidden relative">
      ...
      <div className="w-full max-w-md px-4 z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 font-medium">Watch prices fall, not your savings.</p>
        </div>

        <div className="bg-gray-900/40 backdrop-blur-2xl p-8 rounded-[2.5rem] border border-gray-800 shadow-2xl">
          <div className="flex bg-black/40 p-1 rounded-2xl mb-8 border border-gray-800/50">
            <button
              onClick={() => setIsRegistering(false)}
              className={`flex-1 py-3 px-4 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${!isRegistering ? "bg-gray-800 text-white shadow-lg" : "text-gray-500 hover:text-gray-300"}`}
            >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full p-4 pl-12 bg-black/40 border border-gray-800 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-white placeholder-gray-600 transition-all font-medium"
                  required
                />
              </div>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800/50">
            <p className="text-center text-gray-600 text-xs font-medium mb-4 italic">
              "The best price is the one you track."
            </p>
            <div className="flex items-center justify-center gap-4 text-gray-500">
              <button className="p-2 hover:bg-gray-800 rounded-lg transition-colors"><LuGithub size={20} /></button>
            </div>
          </div>
        </div>
      </div>
